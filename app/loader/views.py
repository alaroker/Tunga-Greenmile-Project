...
@loader.route('/packages', methods=['GET', 'POST'])
@login_required
def list_packages():
    """
    List all packages
    ...
    return render_template('loader/packages/packages.html',
                           packages=packages, title="Packages")


@loader.route('/packages/add', methods=['GET', 'POST'])
@login_required
def add_package():
    """
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('loader.list_packages'))

    # load department template
    return render_template('loader/packages/package.html', action="Add",
                           add_package=add_package, form=form,
                           title="Add Package")


@loader.route('/packages/edit/<int:id>', methods=['GET', 'POST'])
@login_required
def edit_package(id):
    """
    Edit a package
    ...
    return render_template('loader/packages/package.html', action="Edit",
                           add_package=add_package, form=form,
                           package=package, title="Edit Package")


@loader.route('/packages/delete/<int:id>', methods=['GET', 'POST'])
@login_required
...
def list_loaders():
    ...
    return render_template('loader/loaders/loaders.html',
                           loaders=loaders, title='Loaders')


@loader.route('/loaders/assign/<int:id>', methods=['GET', 'POST'])
@login_required
def assign_loaders(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('loader.list_loaders'))

    return render_template('loader/loaders/loader.html',
